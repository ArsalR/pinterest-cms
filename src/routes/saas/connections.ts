// src/routes/saas/connections.ts
...
import { audit, type Customer } from "../../lib/saas/customers"
import { allowRate, AUTH_LIMITS, RATE_LIMIT_MESSAGE } from "../../lib/saas/rateLimit"
import {
  saveConnection, listConnections, deleteConnection, getConnectionSecret,
  type ConnectionProvider, type ConnectionView,
} from "../../lib/saas/connections"
import { githubAppConfigured, githubInstallUrl, getInstallation } from "../../lib/saas/github"
import { CF_TOKEN_TEMPLATE, verifyCfToken, listCfZones, type CfZone } from "../../lib/saas/cloudflare"
import { verifyAnthropicKey } from "../../lib/saas/anthropic"
import { credentialPreview } from "../../lib/saas/vault"
