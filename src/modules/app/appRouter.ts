...
import {
  sitesPageHandler, createSitePostHandler, createSubdomainSiteHandler, createSubdirectorySiteHandler, siteDetailHandler, siteRetryHandler,
...
saasAppRoutes.post("/sites/subdirectory", prot(createSubdirectorySiteHandler))
...
saasAppRoutes.get("/sites/:id/inbox", prot(inboxHandler))
saasAppRoutes.get("/sites/:id/inbox/:subId", prot(inboxDetailHandler))
...
// Integrations (V1.5 M2)
saasAppRoutes.get("/sites/:id/integrations", prot(integrationsHandler))
saasAppRoutes.post("/sites/:id/integrations/keys/create", prot(integrationsCreateKeyHandler))
saasAppRoutes.post("/sites/:id/integrations/keys/revoke", prot(integrationsRevokeKeyHandler))
saasAppRoutes.get("/sites/:id/integrations/webhooks", prot(integrationsWebhooksHandler))
...
saasAppRoutes.post("/sites/:id/images/license", prot(imageLicenseSaveHandler))
...
saasAppRoutes.get("/sites/:id/authors", prot(authorsHandler))
saasAppRoutes.post("/sites/:id/authors", prot(authorsSaveHandler))
saasAppRoutes.post("/sites/:id/authors/delete", prot(authorsDeleteHandler))
saasAppRoutes.get("/sites/:id/merchant", prot(merchantSeoHandler))
saasAppRoutes.post("/sites/:id/merchant/config", prot(merchantConfigSaveHandler))
saasAppRoutes.post("/sites/:id/merchant/products", prot(merchantProductsSaveHandler))
