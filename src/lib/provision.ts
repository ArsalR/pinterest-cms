...
export const SITE_SCHEMA_STATEMENTS: readonly string[] = [
  ...
  `CREATE TABLE IF NOT EXISTS seo_settings (id TEXT PRIMARY KEY DEFAULT 'default', block_ai_bots INTEGER NOT NULL DEFAULT 0, blocked_bots TEXT, disallow_paths TEXT, robots_extra TEXT, rss_enabled INTEGER NOT NULL DEFAULT 1, archives_enabled INTEGER NOT NULL DEFAULT 1, global_schema_enabled INTEGER NOT NULL DEFAULT 0, org_name TEXT, org_logo TEXT, social_profiles TEXT, profiles TEXT, updated_at TEXT DEFAULT (datetime('now')))`,
