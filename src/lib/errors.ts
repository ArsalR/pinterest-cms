...
/** The same 16 codes as a runtime array (for the OpenAPI doc's error enum).
 *  Add-only, in sync with the ErrorCode union above — never rename/remove. */
export const ERROR_CODES: ErrorCode[] = [
  "auth_missing", "auth_invalid_format", "auth_key_not_found", "auth_key_inactive",
  "auth_permission_denied", "validation_required_field", "validation_invalid_value",
  "not_found", "slug_conflict", "idempotency_key_invalid", "idempotency_conflict",
  "upload_too_many_files", "upload_file_too_large", "upload_invalid_mime", "rate_limited", "internal_error",
]
